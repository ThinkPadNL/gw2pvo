...
class GoodWeApi:
    ...
    def getCurrentReadings(self):
        ...
        message = "Inverter status {status}, {pgrid_w} W now, {eday_kwh} kWh today, {etotal_kwh} kWh all time, {grid_voltage} V grid, {pv_voltage} V PV, Inverter temperature {temperature}°C".format(**result)
